...
//this is the white win button
public class WhiteWinButton extends JButton implements MouseListener {
    ChessPvPMenu menu;


    public WhiteWinButton(ChessPvPMenu menu) {
        super("white win");
        this.menu = menu;
        ImageIcon givenIcon = new ImageIcon(new ImageIcon("./src/main/ui/things/pngwing.com.png")
