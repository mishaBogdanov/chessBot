...
//this is the next button in game overview
public class NextButton extends JButton implements MouseListener {
    ChessViewGame currentGame;

    public NextButton(ChessViewGame game) {
        super("Next move");
        this.currentGame = game;
        ImageIcon givenIcon = new ImageIcon(new ImageIcon("./src/main/ui/things/right-arrow.png")
